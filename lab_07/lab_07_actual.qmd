...
county_pop_2014 <- read_csv("county_population_2014.csv")
state_pop_2014 <- read_csv("state_population_2014.csv")
...
**The state of Missouri saw a massive, 36,000 percent increase in its
number of purchased opioid pills.**
...
# The U.S. state with the highest number of opioid pills shipped per person was Delaware. 33,686,260 total pills were shipped at a rate of 12.24 pills per person. Washington, D.C. had a higher number of opioid pills shipped per person in 2014. D.C. shipped 8,599,410 pills at a rate of 13.57 pills per person.
