...
total_crime_rate_lb <- v_crime_rate_lb %>%
  ...
  filter(year >= "2012" & year <= "2023") %>%
  mutate(crimes_per_1000 = (total_crime/population) * 1000)
...
Negligent Manslaughter was the least committed crime with only 2 reports from 2012-2023 (Lynchburg Police Department).
